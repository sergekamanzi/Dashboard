      ...
      {reports.length === 0 ? (
        ...
        <div className="grid grid-cols-1 gap-6">
          {reports.map((report) => (
            <div
              key={report.id}
              className="bg-white p-6 rounded-lg border-2 border-green-500 hover:border-orange-500 transition"
            >
                ...
                {isAdmin ? (
                  ...
                  <>
                    <div className="bg-gray-50 p-4 rounded">
                      ...
                      <p className="font-bold text-green-500">{report.consumption} kWh</p>
                    </div>
                    <div className="bg-gray-50 p-4 rounded">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                <div className="bg-green-100 border-2 border-green-500 p-4 rounded">
                  ...
                  <p className="text-2xl font-bold text-green-600">{report.consumption} kWh</p>
                </div>
                ...
                <div className="bg-gray-50 border-2 border-green-500 p-4 rounded">
