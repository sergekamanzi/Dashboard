...
const PredictionSection = ({ onGenerateReport }: PredictionSectionProps) => {
  ...
  <div className="min-h-screen bg-white text-black p-8">
      <div className="max-w-6xl mx-auto space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 bg-white border border-gray-200 rounded-lg text-black placeholder-black focus:outline-none focus:border-green-500"
              />
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
            <div>
              ...
              <select
                ...
                className="w-full px-4 py-3 bg-white border border-gray-200 rounded-lg text-black focus:outline-none focus:border-green-500"
              >
        ...
        {/* Success Message */}
        {showSuccess && (
          <div className="bg-green-500 text-white p-4 rounded-lg font-bold text-center">
                  ...
                  <tbody>
                    {predictions.appliances.map((app, index) => (
                      <tr key={index} className="border-b border-gray-200">
                        ...
                        <td className="p-4 text-green-500">{app.consumption}</td>
            ...
            <div className="bg-white rounded-2xl p-8 border border-gray-200">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
                  ...
                  <div>
                    ...
                    <p className={`text-2xl font-bold ${
                      predictions.budgetStatus === 'over_budget' ? 'text-red-400' : 'text-green-400'
                    }`}>
              ...
              <div className="overflow-x-auto">
                <table className="w-full">
                  ...
                  <tbody>
                    {generateRecommendations().map((rec, index) => (
                      <tr key={index} className="border-b border-gray-200 hover:bg-gray-50 transition">
                        ...
                        <td className="p-3">
                          <div className="text-sm">
                            <span className={rec.recommendedHours < rec.currentHours ? 'text-green-400' : 'text-black'}>
                              {rec.recommendedHours}h/day
                            </span>
                            <br />
                            <span className={rec.recommendedDays < rec.currentDays ? 'text-green-400' : 'text-black'}>
                              {rec.recommendedDays} days/month
                            </span>
                          </div>
                        </td>
                        <td className="p-3 text-orange-400 font-medium">{rec.currentBill.toFixed(0)} RWF</td>
                        <td className="p-3 text-green-400 font-medium">{rec.recommendedBill.toFixed(0)} RWF</td>
                        <td className="p-3">
                          {rec.savings > 0 ? (
                            <span className="text-green-500 font-bold">-{rec.savings.toFixed(0)} RWF</span>
                          ) : (
                  ...
                  <tfoot>
                    <tr className="border-t-2 border-green-500 bg-gray-800">
              ...
              <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="bg-blue-900 bg-opacity-20 border border-blue-500 p-4 rounded-lg">
                  <h3 className="font-bold text-blue-400 mb-2">Regional Insight: {householdData.region}</h3>
                ...
                <div className="bg-purple-900 bg-opacity-20 border border-purple-500 p-4 rounded-lg">
                  <h3 className="font-bold text-purple-400 mb-2">Income Level: {householdData.incomeLevel}</h3>
