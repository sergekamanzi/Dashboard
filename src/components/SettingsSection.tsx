      ...
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        {/* User Account Management Section */}
          ...
          <div className="flex items-center gap-6 mb-8">
            <div className="relative">
              <div className="w-24 h-24 rounded-full bg-gray-50 border-2 border-green-500 flex items-center justify-center overflow-hidden">
              ...
              <label htmlFor="imageUpload" className="absolute bottom-0 right-0 bg-green-500 p-2 rounded-full cursor-pointer hover:bg-green-600 transition">
        ...
        <div className="bg-white rounded-2xl p-8 border border-gray-200">
          ...
          <form onSubmit={handlePasswordChange} className="space-y-6">
            ...
            <button 
              type="submit"
              className="bg-orange-500 hover:bg-orange-600 text-black font-bold px-8 py-3 rounded-lg transition"
            >
              Change Password
            </button>
          </form>
